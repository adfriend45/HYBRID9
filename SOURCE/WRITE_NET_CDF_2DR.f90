!======================================================================!
SUBROUTINE WRITE_NET_CDF_2DR (data_out)
!----------------------------------------------------------------------!
...
!----------------------------------------------------------------------!
REAL, INTENT (IN) :: data_out (lon_c,lat_c)
!----------------------------------------------------------------------!
...
! Define the variable.
!----------------------------------------------------------------------!
CALL CHECK (nf90_def_var(ncid, TRIM(var_name), NF90_float, dimids_two, &
  varid))
!----------------------------------------------------------------------!
...
!----------------------------------------------------------------------!
END SUBROUTINE WRITE_NET_CDF_2DR
!======================================================================!
