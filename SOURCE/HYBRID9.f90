...
!**********************************************************************!
            ...
            !----------------------------------------------------------!
            xs1 = MAX (MAX (h2osoi_liq (1,x,y), 0.0) - &
                  MAX (0.0, (theta_s (1,x,y) * dz (1))), 0.0)
            h2osoi_liq (1,x,y) = MIN (MAX (0.0, &
                                 theta_s (1,x,y) * dz (1)), &
                                 h2osoi_liq (1,x,y))
            !----------------------------------------------------------!
            ...
            !----------------------------------------------------------!
            DO I = 1, nlayers - 1
              IF (h2osoi_liq (I,x,y) < theta_m (I,x,y)) THEN
                xs = theta_m (I,x,y) - h2osoi_liq (I,x,y)
